    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-success">
                <p>Valor máximo: <?php echo $data['max']; ?></p>
                <p>Valor mínimo: <?php echo $data['min']; ?></p>
            </div>
        </div>
    </div>
    <?php
    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Máximo y mínimo</h6>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div>
                        <p><?php echo $data['orderedNumbers']?></p>
                    </div>
                </form>
            </div>
        </div>
